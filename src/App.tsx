        ...
        <BrowserRouter>
          ...
          <div className="flex bg-[#050505] min-h-screen text-white font-sans selection:bg-[#0055FF] selection:text-white">
            ...
            <main className="flex-1 md:ml-64 min-h-screen relative overflow-hidden">
              <div className="absolute inset-0 p-8 md:p-16 lg:p-24 overflow-y-auto overflow-x-hidden">
                <div className="max-w-7xl mx-auto pb-32">
                  <Suspense fallback={<LoadingFallback />}>
                    <Routes>
                      <Route path="/" element={<Dashboard />} />
                      
                      {/* Securely Prefixed pSEO Routes */}
                      <Route path="/tools/:calculator/:region" element={<PSEOLandingPage />} />
                      <Route path="/calculators/:calculator/:region" element={<PSEOLandingPage />} />
                      
                      {/* Static Tools - Must come before 2-segment greedy routes */}
                      ...
                      {/* Greediest pSEO Pattern - Must stay at bottom */}
