    ...
    <div className="space-y-8 pb-20 text-white">
      <header className="space-y-2">
        <div className="flex items-center gap-2 mb-4">
           <Globe className="text-[#0055FF] w-6 h-6" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {TAX_GUIDES.map((guide, idx) => (
          <div key={idx} className="bg-white/[0.02] border border-white/5 rounded-2xl overflow-hidden hover:border-[#0055FF]/30 transition-all group">
            <div className="p-6 border-b border-white/5 bg-white/[0.01] flex justify-between items-center">
               ...
               <ShieldCheck className="w-5 h-5 text-[#0055FF] opacity-0 group-hover:opacity-100 transition-opacity" />
            </div>
            <div className="p-6 space-y-4">
               {guide.instruments.map((ins, i) => (
                 <div key={i} className="space-y-1">
                    <div className="flex items-center gap-2 font-bold text-sm">
                       <div className="w-1 h-1 rounded-full bg-[#0055FF]"></div>
                       {ins.name}
                    </div>
            ...
            <div className="p-4 bg-white/[0.01] flex justify-center border-t border-white/5">
                <button className="text-[10px] font-bold text-white/20 uppercase tracking-widest hover:text-[#0055FF] transition-colors flex items-center gap-2">
      ...
      <div className="p-8 bg-[#0055FF]/5 border border-[#0055FF]/10 rounded-2xl flex flex-col md:flex-row items-center gap-6">
         <div className="w-12 h-12 bg-[#0055FF] rounded-full flex items-center justify-center shrink-0">
         ...
         <button className="ml-auto px-6 py-3 bg-[#0055FF] rounded-xl text-xs font-bold hover:bg-[#0044DD] transition-all">
            Consult Advisor
         </button>
      </div>
    </div>
