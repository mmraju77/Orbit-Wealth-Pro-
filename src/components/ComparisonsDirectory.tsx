    ...
    <div className="space-y-12 pb-20">
      ...
      <header className="space-y-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-[10px] font-black text-[#D4AF37] uppercase tracking-[0.4em] drop-shadow-[0_0_8px_rgba(212,175,55,0.3)]">Intelligence Directory</span>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <div className="pt-4 flex items-center gap-2 text-[10px] font-black text-[#D4AF37] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all translate-x-[-10px] group-hover:translate-x-0">
