  ...
  return (
    <div className="space-y-12 pb-20 text-white">
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 pt-8">
        <header className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
             ...
             <span className="text-base font-bold text-[#D4AF37] uppercase tracking-[0.3em]">Capital Yield Logistics</span>
          </div>
          <h1 className="text-7xl font-display font-medium text-[#f59e0b] tracking-tight">Property ROI.</h1>
      ...
      <CalculatorSEO
        ...
        description="Calculate your rental yield  easily and accurately with Orbit Wealth Pro."
        faqs={[{
          question: "What is the Rental Yield  Calculator?",
          answer: "The Rental Yield  Calculator is a financial tool designed to help you calculate and estimate your figures accurately."
        }, {
