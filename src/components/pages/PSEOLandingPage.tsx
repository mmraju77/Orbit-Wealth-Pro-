...
const IncomeTaxCalculator = lazy(() => import('../calculators/IncomeTaxCalculator'));
const GSTCalculator = lazy(() => import('../calculators/GSTCalculator'));
const FDRDCalculator = lazy(() => import('../calculators/FDRDCalculator'));
...
const BalanceTransfer = lazy(() => import('../calculators/BalanceTransfer'));
const GratuityCalculator = lazy(() => import('../calculators/GratuityCalculator'));
const CurrencyConverter = lazy(() => import('../calculators/CurrencyConverter'));
const MFCalculator = lazy(() => import('../calculators/MFCalculator'));
const PersonalLoanCalculator = lazy(() => import('../calculators/PersonalLoanCalculator'));
const AutoLoanCalculator = lazy(() => import('../calculators/AutoLoanCalculator'));
const StudentLoanCalculator = lazy(() => import('../calculators/StudentLoanCalculator'));
const TermInsuranceCalculator = lazy(() => import('../calculators/TermInsuranceCalculator'));
const HealthInsuranceCalculator = lazy(() => import('../calculators/HealthInsuranceCalculator'));
