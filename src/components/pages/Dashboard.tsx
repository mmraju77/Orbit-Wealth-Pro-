...
const MarketTicker = React.lazy(() => import('../ui/MarketTicker'));
const WealthIntelligenceBlock = React.lazy(() => import('../ui/WealthIntelligenceBlock'));
const BlogPreview = React.lazy(() => import('./BlogPreview'));
const WealthMilestones = React.lazy(() => import('../calculators/WealthMilestones'));
...
const CATEGORIES = [
  {
    ...
    id: 'wealth',
    cards: [
      { title: 'SIP Manager', description: 'Systematic investment planning with precise compound return logic.', path: '/calculators/investing/sip', icon: TrendingUp, color: 'text-blue-500' },
      { title: 'Investment CAGR', description: 'Determine the geometric progression of your assets over time.', path: '/calculators/investing/cagr', icon: Target, color: 'text-emerald-500' },
      { title: 'Mutual Funds', description: 'Analyze performance metrics and projected absolute returns.', path: '/calculators/investing/mutual-fund', icon: PieChart, color: 'text-cyan-500' },
      { title: 'Lumpsum Growth', description: 'Project future values of one-time capital injections.', path: '/calculators/investing/lumpsum', icon: BarChart3, color: 'text-indigo-500' },
      { title: 'Dividend Yield', description: 'Analyze passive income generated by stock portfolios.', path: '/calculators/investing/dividend-yield', icon: Coins, color: 'text-amber-500' },
      { title: 'Retirement Pot', description: 'Architect your post-career financial state with inflation modeling.', path: '/calculators/investing/retirement', icon: Coins, color: 'text-purple-500' },
      { title: 'Forex Converter', description: 'Real-time exchange engine for global currency pairs.', path: '/calculators/forex/currency-converter', icon: RefreshCcw, color: 'text-rose-500' },
    ]
  },
  {
    name: 'Debt & Credit',
    id: 'debt',
    cards: [
      { title: 'Debt Snowball', description: 'Eliminate debt systematically targeting small balances first.', path: '/calculators/loans/debt-snowball', icon: Zap, color: 'text-orange-500' },
      { title: 'CC Payoff', description: 'Simulate credit card liquidation and interest drain analysis.', path: '/calculators/loans/credit-card-payoff', icon: CreditCard, color: 'text-rose-500' },
      { title: 'Mortgage / Home', description: 'Professional-grade home loan amortization scheduling.', path: '/calculators/loans/mortgage', icon: Landmark, color: 'text-slate-400' },
      { title: 'EMI Engine', description: 'Universal Equated Monthly Installment tool for all loans.', path: '/calculators/loans/emi', icon: CreditCard, color: 'text-indigo-500' },
      { title: 'Auto Loan', description: 'Finance modeling for vehicle acquisitions with tax logic.', path: '/calculators/loans/auto-loan', icon: CreditCard, color: 'text-blue-500' },
      { title: 'Student Debt', description: 'Plan for education costs with grace period adjustments.', path: '/calculators/loans/student-loan', icon: Landmark, color: 'text-emerald-500' },
      { title: 'Loan Transfer', description: 'Optimize your interest drain with mortgage balance transfers.', path: '/calculators/loans/home-loan-transfer', icon: ArrowRightLeft, color: 'text-sky-500' },
    ]
  },
  {
    ...
    id: 'insurance',
    cards: [
      { title: 'HLV Calculator', description: 'Quantify your economic value and ideal coverage needs.', path: '/calculators/insurance/hlv', icon: ShieldCheck, color: 'text-rose-500' },
      { title: 'Term Life', description: 'Plan for long-term family security with term insurance.', path: '/calculators/insurance/term-insurance', icon: Shield, color: 'text-blue-500' },
      { title: 'Health Guard', description: 'Analyze health premium costs vs benefit coverage.', path: '/calculators/insurance/health-insurance', icon: ShieldCheck, color: 'text-emerald-500' },
    ]
  },
  {
    name: 'Business & Yield',
    id: 'business',
    cards: [
      { title: 'Break-Even Point', description: 'Determine the neutrality point for new business products.', path: '/calculators/business/break-even', icon: Target, color: 'text-indigo-500' },
      { title: 'Rental ROI', description: 'Evaluate real estate profitability and net rental yields.', path: '/calculators/investing/rental-yield', icon: Building, color: 'text-cyan-500' },
      { title: 'Gratuity Pot', description: 'Calculate statutory retirement benefits based on tenure.', path: '/calculators/salary/gratuity', icon: Gift, color: 'text-sky-500' },
    ]
  },
  {
    name: 'Global Taxes',
    id: 'taxes',
    cards: [
      { title: 'Income Tax', description: 'Compare regimes for USA, UK, India, and European zones.', path: '/calculators/tax/income-tax', icon: Percent, color: 'text-orange-500' },
      { title: 'GST / VAT', description: 'Calculate transaction taxes based on multi-country rates.', path: '/calculators/tax/gst', icon: ShieldCheck, color: 'text-indigo-500' },
