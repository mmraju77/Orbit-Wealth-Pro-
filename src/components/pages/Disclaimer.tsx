  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-12 text-white">
      <header className="space-y-4 text-center">
        ...
        <h1 className="text-6xl font-bold tracking-tighter text-[#f59e0b]">Financial Disclaimer</h1>
        <p className="text-white/70 text-lg uppercase tracking-widest font-bold">Important Notice to Our Users</p>
      </header>
      ...
      <div className="bg-white/[0.03] backdrop-blur-md border border-white/5 rounded-2xl p-8 md:p-12 space-y-8 leading-relaxed text-white/70">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3 text-white">
            ...
            <h2 className="text-3xl font-bold tracking-tight">Market Risk & Model Accuracy</h2>
          </div>
          <p>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3 text-white">
            ...
            <h2 className="text-3xl font-bold tracking-tight">Consult Professionals</h2>
          </div>
          <p>
        ...
        <section className="space-y-4 border-t border-white/5 pt-8 text-center text-white/70 text-lg italic">
          <p>
