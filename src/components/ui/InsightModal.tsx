    ...
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 md:p-8">
      ...
      >
        ...
        <div className="p-8 pb-10 bg-[#0D121F] border-b border-white/5 flex items-start justify-between relative overflow-hidden">
          ...
          <button 
            aria-label="Close insight" onClick={onClose}
            className="p-2.5 bg-white/5 border border-white/10 rounded-full text-white/70 hover:text-white hover:bg-white/10 transition-all relative z-10 min-h-[44px]"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-8 bg-white border-t border-slate-100 flex items-center justify-between">
          ...
          <button 
            aria-label="Close insight" onClick={onClose}
            className="w-full md:w-auto px-10 py-4 bg-[#0D121F] text-white rounded-2xl font-black text-base uppercase tracking-[0.2em] hover:bg-[#D4AF37] hover:text-[#0B0F19] transition-all shadow-xl min-h-[44px]"
          >
