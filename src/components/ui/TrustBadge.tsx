  ...
  return (
    <footer className="px-10 py-12 border-t border-white/10 bg-[#0A0A0A]">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-12">
        ...
        <div className="text-base font-bold tracking-[0.3em] text-white/70 text-right shrink-0 uppercase">
          SECURED BY ORBIT ARCHITECTURE v2.4
        </div>
      </div>

      <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 gap-6">
        <div className="flex gap-8 text-base font-bold tracking-widest text-white/70 uppercase">
          <button 
        ...
        <div className="text-base text-white/70 font-bold tracking-[0.2em]">
