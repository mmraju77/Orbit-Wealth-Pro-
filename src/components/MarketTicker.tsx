        ...
        {tickerItems.map((item, idx) => (
          ...
          >
            <div className="flex flex-col">
              <span className="text-base font-black text-white uppercase tracking-[0.3em] mb-1.5 opacity-100">
                {item.label}
              </span>
              <div className="flex items-center gap-3">
                ...
                <span className={`text-base font-black px-2.5 py-0.5 rounded-md border ${
