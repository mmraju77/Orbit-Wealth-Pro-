    ...
    <div className="space-y-12 pb-20">
      ...
      <section className="bg-white/[0.02] border border-white/5 rounded-3xl overflow-hidden shadow-2xl">
        <div className="grid grid-cols-1 md:grid-cols-3 bg-white/5 border-b border-white/5">
          ...
          <div className="p-6 md:p-8 text-xl font-bold text-[#D4AF37] flex items-center justify-between border-t md:border-t-0 md:border-l border-white/5">
        ...
        {data.factors.map((f, idx) => (
          <div key={idx} className="grid grid-cols-1 md:grid-cols-3 border-b border-white/5 last:border-0 hover:bg-white/[0.01] transition-colors group">
            <div className="p-6 md:p-8 text-sm font-bold text-white/60 flex items-center bg-white/[0.02]">
                <div className="w-1.5 h-1.5 rounded-full bg-[#D4AF37] mr-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                {f.factor}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 space-y-8 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-4">
             <div className="w-12 h-12 rounded-2xl bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] font-bold border border-[#D4AF37]/20">A</div>
      ...
      {/* The Verdict */}
      <section className="bg-[#D4AF37]/10 border border-[#D4AF37]/20 rounded-3xl p-10 space-y-6 relative overflow-hidden">
        <div className="absolute top-0 right-0 m-12 opacity-5">
            <Target className="w-32 h-32" />
        </div>
        
        <div className="flex items-center gap-3">
            <Lightbulb className="text-[#D4AF37] w-6 h-6" />
        ...
        <div className="pt-8">
            <Link 
                to={data.ctaLink}
                className="inline-flex items-center gap-4 px-8 py-4 bg-[#D4AF37] hover:bg-[#D4AF37]/90 text-white rounded-2xl font-bold transition-all shadow-xl shadow-[#D4AF37]/20 group"
            >
                {data.ctaText}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl flex items-center justify-between group hover:bg-white/[0.04] transition-all">
            ...
            <Link to="/calculators/retirement" className="text-[#D4AF37] font-bold text-sm flex items-center gap-2 group-hover:gap-3 transition-all">
         ...
         <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl flex items-center justify-between group hover:bg-white/[0.04] transition-all">
            ...
            <Link to="/calculators/income-tax" className="text-[#D4AF37] font-bold text-sm flex items-center gap-2 group-hover:gap-3 transition-all">
