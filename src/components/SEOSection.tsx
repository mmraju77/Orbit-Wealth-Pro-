      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[10px] font-bold text-white/60 uppercase tracking-widest">How to use</span>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[10px] font-bold text-white/60 uppercase tracking-widest">The Mathematics</span>
          </div>
