      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs font-bold text-white/70 uppercase tracking-widest">How to use</span>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs font-bold text-white/70 uppercase tracking-widest">The Mathematics</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {benefits.map((benefit, idx) => (
            <div key={idx} className="flex items-start gap-3">
              ...
              <p className="text-base text-white/70 leading-relaxed">{benefit}</p>
            </div>
          ))}
        </div>
      </div>
