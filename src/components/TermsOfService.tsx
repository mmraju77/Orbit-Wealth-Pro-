  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-12 text-white">
      <header className="space-y-4 text-center">
        ...
        <p className="text-white/70 text-base uppercase tracking-widest font-bold">Standard Usage Agreement</p>
      </header>
      ...
      <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 md:p-12 space-y-8 leading-relaxed text-white/70">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white tracking-tight">3. Disclaimer of Accuracy</h2>
          <p>
