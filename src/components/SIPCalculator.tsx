      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 pt-8">
        ...
        <header className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
             ...
             <span className="text-base font-bold text-[#D4AF37] uppercase tracking-[0.3em]">Capital Growth Analysis</span>
          </div>
          <h1 className="text-7xl font-display font-medium text-[#f59e0b] tracking-tight">SIP Intelligence.</h1>
          <p className="text-white/70 max-w-xl text-xl font-light leading-relaxed">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <section className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 space-y-8">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <label htmlFor="investment-period" className="text-base font-bold text-white/70 uppercase tracking-widest">Investment Period (Years)</label>
                <NumericInput 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-white/5">
            <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                <div className="text-base text-white/70 font-bold uppercase tracking-widest mb-1">Invested Amount</div>
                <div className="text-2xl font-bold text-white tracking-tighter">{formatCurrency(results.investedAmount)}</div>
            </div>
            <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                <div className="text-base text-white/70 font-bold uppercase tracking-widest mb-1">Return Amount</div>
