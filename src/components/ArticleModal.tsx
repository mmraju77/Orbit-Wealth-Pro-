                ...
                <div className="lg:col-span-1 space-y-8">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[10px] text-white/70 uppercase font-bold tracking-widest">Author</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[10px] text-white/70 uppercase font-bold tracking-widest">Published</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[10px] text-white/70 uppercase font-bold tracking-widest">Est. Reading</p>
                  ...
                  <div className="pt-8 border-t border-white/5">
                    <p className="text-[10px] text-white/70 uppercase font-bold tracking-widest mb-4">Core Themes</p>
