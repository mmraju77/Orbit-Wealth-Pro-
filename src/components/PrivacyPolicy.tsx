  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-12 text-white">
      <header className="space-y-4 text-center">
        ...
        <h1 className="text-6xl font-bold tracking-tighter">Privacy Policy</h1>
        <p className="text-white/70 text-lg uppercase tracking-widest font-bold">Last Updated: May 2026</p>
      </header>
      ...
      <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 md:p-12 space-y-8 leading-relaxed text-white/70">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3 text-white">
            ...
            <h2 className="text-3xl font-bold tracking-tight">Google Analytics (GA4)</h2>
          </div>
          <p>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3 text-white">
            ...
            <h2 className="text-3xl font-bold tracking-tight">Google AdSense & DoubleClick</h2>
          </div>
          <p>
          ...
          <p>
            Users may opt-out of the use of the DART cookie by visiting the Google ad and content network privacy policy at the following URL: <a href="https://www.google.com/privacy_ads.html" className="text-[#D4AF37] hover:underline">https://www.google.com/privacy_ads.html</a>
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="text-3xl font-bold text-white tracking-tight">Data Protection</h2>
          <p>
