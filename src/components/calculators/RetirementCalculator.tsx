  ...
  return (
    <div className="space-y-12 pb-20 text-white">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
        <header className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
             ...
             <span className="text-base font-bold text-[#D4AF37] uppercase tracking-[0.3em]">Retirement Logistics</span>
          </div>
          <h1 className="text-7xl font-display font-medium text-[#f59e0b] tracking-tight">Sunset Provisions.</h1>
        ...
        <section className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 space-y-8">
           <div className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
                 ...
                 <div className="space-y-4">
                    <label className="text-base font-bold text-white/70 uppercase tracking-widest">Retirement Age</label>
                    <NumericInput 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
                 ...
                 <div className="space-y-4">
                    <label className="text-base font-bold text-white/70 uppercase tracking-widest">Inflation Rate (%)</label>
                    <NumericInput 
                      step="0.1" 
      ...
      <CalculatorSEO
        ...
        description="Calculate your retirement  easily and accurately with Orbit Wealth Pro."
        faqs={[{
          question: "What is the Retirement  Calculator?",
          answer: "The Retirement  Calculator is a financial tool designed to help you calculate and estimate your figures accurately."
        }, {
