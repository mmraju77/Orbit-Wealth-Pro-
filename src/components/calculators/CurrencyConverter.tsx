      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <header className="space-y-2">
          <div className="flex items-center gap-2 mb-4">
             ...
             <h1 className="text-5xl font-bold tracking-tighter">Currency Converter</h1>
          </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        <section className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 space-y-12">
            <div className="space-y-8">
               <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <label className="text-base font-bold text-white/70 uppercase tracking-widest">Amount to Convert</label>
               ...
               <div className="flex flex-col md:flex-row items-center gap-4">
                  <div className="flex-1 w-full space-y-4">
                     <label className="text-base font-bold text-white/70 uppercase tracking-widest px-2">From</label>
                     <select 
                       value={from}
                       onChange={(e) => {
                  ...
                  <button 
                    ...
                    className="mt-6 p-4 rounded-full bg-white/5 border border-white/10 hover:bg-[#D4AF37]/10 hover:border-[#D4AF37]/30 transition-all group min-h-[44px]"
                  >
                    <ArrowRightLeft className="w-6 h-6 text-white/70 group-hover:text-[#D4AF37] transition-colors" />
                  </button>

                  <div className="flex-1 w-full space-y-4">
                     <label className="text-base font-bold text-white/70 uppercase tracking-widest px-2">To</label>
                     <select 
                       value={to}
                       onChange={(e) => {
            ...
            <div className="space-y-2 pt-8 border-t border-white/5">
                <div className="text-base font-bold text-white/70 uppercase tracking-widest">Indicative Exchange Rate</div>
                <div className="text-2xl font-bold text-white">1 {from} = <span className="text-[#D4AF37]">{exchangeRate.toFixed(4)}</span> {to}</div>
            </div>
        </section>
               ...
               <div className="flex-1 mt-8">
                  <div className="flex items-center justify-between mb-4">
                     <div className="flex items-center gap-2">
                        ...
                        <span className="text-base font-bold text-white/70 uppercase tracking-widest">30-Day Trend</span>
                     </div>
