    ...
    <div className="space-y-12 pb-20 text-white">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
        ...
        <div className="flex items-center gap-2">
          <button className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/5 rounded-lg text-base font-bold transition-all min-h-[44px]">
