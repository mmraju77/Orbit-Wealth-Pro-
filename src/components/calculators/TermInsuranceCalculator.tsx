  ...
  return (
    <div className="space-y-12 pb-20 text-white">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
        <header className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
             ...
             <span className="text-base font-bold text-[#D4AF37] uppercase tracking-[0.3em]">Life Protection</span>
          </div>
          <h1 className="text-7xl font-display font-medium text-[#f59e0b] tracking-tight">Term Insurance.</h1>
        ...
        <div className="flex items-center gap-2">
          <button className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/5 rounded-lg text-base font-bold transition-all min-h-[44px]" aria-label="Button action">
          ...
          <div className="space-y-8">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
               <div className="space-y-4">
                  <label className="text-base font-bold text-white/70 uppercase tracking-widest">Current Age</label>
               ...
               <div className="space-y-4">
                  <label className="text-base font-bold text-white/70 uppercase tracking-widest">Policy Term (Years)</label>
                  <div className="space-y-4">
                    <NumericInput 
                      min={5} max={50} 
                      value={inputs.term}
           ...
           {isMounted && (
             <>
               ...
               <div className="w-full space-y-4 pt-8 border-t border-white/5">
                  <div className="flex justify-between items-center text-base uppercase font-bold tracking-widest">
                  ...
                  <div className="flex justify-between items-center text-base uppercase font-bold tracking-widest pt-4">
      ...
      <CalculatorSEO
        ...
        title="Term Insurance  Calculator"
        description="Calculate your term insurance  easily and accurately with Orbit Wealth Pro."
        faqs={[{
          question: "What is the Term Insurance  Calculator?",
          answer: "The Term Insurance  Calculator is a financial tool designed to help you calculate and estimate your figures accurately."
        }, {
