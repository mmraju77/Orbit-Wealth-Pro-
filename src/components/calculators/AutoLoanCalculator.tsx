      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <header className="space-y-2">
          <div className="flex items-center gap-2 mb-4">
             ...
             <h1 className="text-5xl font-bold tracking-tighter">Auto Loan Calculator</h1>
          </div>
        ...
        <section className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             <div className="space-y-4">
                <label className="text-base font-bold text-white/70 uppercase tracking-widest">Car Price</label>
                <div className="flex items-center gap-2 bg-black/40 p-3 rounded-xl border border-white/5">
                   <span className="text-[#D4AF37] font-bold">{currencySymbol}</span>
                   <NumericInput 
                     value={carPrice}
                     onChange={setCarPrice}
                     className="bg-transparent border-none text-white font-bold w-full outline-none text-2xl"
                   />
                </div>
             </div>
             <div className="space-y-4">
                <label className="text-base font-bold text-white/70 uppercase tracking-widest">Sales Tax (%)</label>
                <div className="flex items-center gap-2 bg-black/40 p-3 rounded-xl border border-white/5">
                   <NumericInput 
                     value={salesTax}
             ...
             <div className="space-y-4">
                <label className="text-base font-bold text-white/70 uppercase tracking-widest">Trade-in Value</label>
                <div className="flex items-center gap-2 bg-black/40 p-3 rounded-xl border border-white/5">
                   <span className="text-[#D4AF37] font-bold">{currencySymbol}</span>
                   <NumericInput 
                     value={tradeIn}
           ...
           <div className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 ...
                 <div className="p-6 bg-white/5 rounded-2xl border border-white/5 text-center">
                    <div className="text-base text-white/70 font-bold uppercase tracking-widest mb-1">Total Loan</div>
                    <div className="text-xl md:text-2xl font-bold text-white/70">{formatCurrency(results.loanAmount)}</div>
                 </div>
              </div>
              ...
              <div className="p-6 bg-white/[0.01] border border-white/5 rounded-2xl space-y-4">
                 <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="text-base font-bold text-white uppercase tracking-widest">Summary Breakdown</h4>
                 </div>
