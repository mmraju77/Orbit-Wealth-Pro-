      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <header className="space-y-2">
          <div className="flex items-center gap-2 mb-4">
             ...
             <h1 className="text-5xl font-bold tracking-tighter text-[#f59e0b]">Lumpsum Calculator</h1>
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleShare} className="flex items-center gap-2 px-4 py-2 bg-[#D4AF37] hover:bg-[#D4AF37]/90 rounded-lg text-base font-bold transition-all shadow-lg shadow-[#D4AF37]/20 min-h-[44px]" aria-label="Button action">
