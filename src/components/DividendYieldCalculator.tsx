      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 pt-8">
        <header className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
             ...
             <span className="text-base font-bold text-[#D4AF37] uppercase tracking-[0.3em]">Passive Income Analytics</span>
          </div>
          <h1 className="text-7xl font-display font-medium text-[#f59e0b] tracking-tight">Dividend Yields.</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        <section className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 space-y-8">
          ...
          <div className="space-y-4">
             ...
             />
             <input 
               aria-label="Adjust value" type="range" min="1" max="10000" step="10"
               value={sharesOwned}
