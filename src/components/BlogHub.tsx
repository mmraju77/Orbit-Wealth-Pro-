    ...
    <div className="space-y-12 pb-20">
      ...
      <header className="space-y-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-[10px] font-black text-[#D4AF37] uppercase tracking-[0.4em] drop-shadow-[0_0_8px_rgba(212,175,55,0.3)]">Knowledge Base</span>
        </div>
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            <h1 className="text-5xl md:text-6xl font-display font-bold tracking-tight text-white leading-[1.1]">
              Wealth <br />
        ...
        <AnimatePresence mode="popLayout">
          {filteredArticles.map((article, idx) => (
            ...
            <div className="p-8 flex-1 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-white mb-4 line-clamp-2 leading-snug group-hover:text-[#D4AF37] transition-colors">
                {article.title}
              </h3>

              <p className="text-sm !text-white !opacity-100 leading-relaxed line-clamp-3 mb-8 font-medium">
                {article.excerpt}
              </p>
              ...
              <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-[11px] font-bold text-white">{article.author}</h4>
