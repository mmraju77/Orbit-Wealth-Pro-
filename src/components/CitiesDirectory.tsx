            ...
            >
              ...
              <div className="space-y-2">
                {['Income Tax', 'Mortgage', 'SIP'].map(calc => (
                   <div key={calc} className="text-base text-white/70 hover:text-[#D4AF37] transition-colors">{calc} Tool</div>
                ))}
              </div>
            </Link>
          </motion.div>
        ...
        <div className="relative z-10 space-y-12">
            ...
            <div className="pt-8 border-t border-white/5">
                ...
                <div className="flex flex-wrap gap-3">
                   ...
                   <span className="px-4 py-2 bg-[#D4AF37]/10 rounded-full text-base text-[#D4AF37] border border-[#D4AF37]/20 uppercase font-black">
                     + Many More
                   </span>
                </div>
            </div>
