      ...
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-20 space-y-6">
          <div className="flex items-center gap-3">
             ...
             <span className="text-base font-black text-amber-500 uppercase tracking-[0.4em]">Corporate Genesis</span>
          </div>
          <h1 className="text-7xl md:text-9xl font-black text-white tracking-tighter leading-[0.9] max-w-3xl">
            Architecting the future of <span className="text-amber-500">Wealth Intelligence.</span>
          </h1>
          <p className="text-white/70 text-2xl max-w-2xl leading-relaxed font-light">
              ...
              <div className="flex-1 space-y-10 text-center lg:text-left pt-4">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-center lg:justify-start gap-3">
                    ...
                    <span className="text-base font-black text-amber-500 uppercase tracking-[0.4em]">Chief AI Architect & Founder</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-8 pt-6">
                  <a 
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-4 bg-white text-black px-10 py-5 rounded-full text-base font-black uppercase tracking-[0.2em] hover:bg-amber-500 hover:text-black hover:scale-105 transition-all duration-500 shadow-2xl shadow-white/5 active:scale-95"
                  >
                    <Linkedin className="w-5 h-5 fill-current" />
                    Connect via LinkedIn
                  </a>
                  <div className="flex flex-col items-start gap-1">
                     <span className="text-base uppercase tracking-widest font-black text-white/70">Security Clearance</span>
                     <span className="text-base font-mono text-amber-500">ID: OWP-SYS-GEN-2026-MMR</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 pb-20">
          <motion.div variants={itemVariants} className="p-10 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-4 hover:border-amber-500/30 transition-colors">
            ...
            <h4 className="text-lg font-black text-white uppercase tracking-widest">Quant Accuracy</h4>
          ...
          <motion.div variants={itemVariants} className="p-10 bg-[#0D121F] border border-white/10 rounded-[2.5rem] space-y-4 hover:border-amber-500/30 transition-colors">
            ...
            <h4 className="text-lg font-black text-white uppercase tracking-widest">Global Reach</h4>
            <p className="text-base text-white/70 leading-relaxed font-medium">
          ...
          <motion.div variants={itemVariants} className="p-10 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-4 hover:border-amber-500/30 transition-colors">
            ...
            <h4 className="text-lg font-black text-white uppercase tracking-widest">Zero Tracking</h4>
            <p className="text-base text-white/70 leading-relaxed font-medium">
