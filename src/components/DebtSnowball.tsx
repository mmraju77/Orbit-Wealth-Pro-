      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 pt-8">
        <header className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-base font-bold text-[#D4AF37] uppercase tracking-[0.3em]">Debt Freedom Strategy</span>
          </div>
          <h1 className="text-7xl font-display font-medium text-[#f59e0b] tracking-tight">Debt Snowball.</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-12">
        <section className="space-y-8 bg-white/[0.01] border border-white/[0.03] p-10 rounded-[2.5rem]">
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={addDebt} className="flex items-center gap-2 px-3 py-1.5 bg-[#D4AF37]/10 text-[#D4AF37] rounded-lg text-base font-bold hover:bg-[#D4AF37]/20 transition-all">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <NumericInput 
                      ...
                      className="w-full bg-transparent border-none outline-none text-base text-white font-mono" 
                    />
                  </div>
                </div>
                <div className="space-y-1">
                 ...
                 {sortedDebts.map((debt, idx) => (
                   <div key={debt.id} className={`flex items-center justify-between p-4 rounded-xl border ${idx === 0 ? 'bg-emerald-500/10 border-emerald-500/20' : 'bg-white/[0.01] border-white/5'}`}>
                      <div className="flex items-center gap-4">
                         <span className="text-base font-bold text-white/70">#{idx + 1}</span>
