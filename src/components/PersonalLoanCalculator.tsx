...
export default function PersonalLoanCalculator() {
  ...
  return (
    <div className="space-y-8 pb-20 text-white">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <header className="space-y-2">
          <div className="flex items-center gap-2 mb-4">
             ...
             <h1 className="text-5xl font-bold tracking-tighter">Personal Loan Calculator</h1>
          </div>
          ...
          <div className="space-y-8">
             ...
             {extraPayment > 0 && (
                <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-6 space-y-4">
                   <h3 className="text-lg font-bold text-emerald-500 uppercase tracking-widest">Early Payoff Impact</h3>
                   <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
      ...
      <CalculatorSEO
        id="PersonalLoanCalculator"
        title="Personal Loan  Calculator"
        description="Calculate your personal loan  easily and accurately with Orbit Wealth Pro."
        faqs={[{
          question: "What is the Personal Loan  Calculator?",
          answer: "The Personal Loan  Calculator is a financial tool designed to help you calculate and estimate your figures accurately."
        }, {
