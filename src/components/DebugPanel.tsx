          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <section>
                <div className="flex items-center gap-2 mb-4 text-[#D4AF37]">
                  ...
                  <span className="text-base font-bold uppercase tracking-widest">Environment Variables</span>
                </div>
                <div className="grid grid-cols-1 gap-2">
                  {systemStats.map((stat, i) => (
                    <div key={i} className="flex justify-between items-center text-base bg-white/[0.02] p-3 border border-white/5 rounded">
              ...
              <section>
                <div className="flex items-center gap-2 mb-4 text-[#D4AF37]">
                  ...
                  <span className="text-base font-bold uppercase tracking-widest">State Store: Locale</span>
                </div>
                <pre className="text-base leading-relaxed text-white/70 bg-black/40 p-4 border border-white/5 rounded overflow-x-auto">
                  {JSON.stringify({ 
                    currency,
                    labels,
              ...
              <section>
                <div className="flex items-center gap-2 mb-4 text-[#D4AF37]">
                  ...
                  <span className="text-base font-bold uppercase tracking-widest">Terminal Output</span>
                </div>
                <div className="bg-[#050505] p-4 rounded border border-white/10 min-h-[150px] text-base text-green-500/80 space-y-1">
                  ...
                  <p className="flex gap-2 text-white/70"><span className="text-[#D4AF37] animate-pulse">_</span></p>
                </div>
              </section>
            </div>
            ...
            <div className="p-6 border-t border-white/10 bg-white/[0.02]">
              ...
              <button 
                ...
                className="w-full py-3 bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/20 text-base font-bold tracking-[0.2em] uppercase transition-colors"
              >
