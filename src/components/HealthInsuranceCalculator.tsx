        ...
        <section className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 space-y-8">
          <div className="space-y-8">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
               <div className="space-y-4">
                  <label className="text-[10px] font-bold text-white/70 uppercase tracking-widest">Age of Oldest Member</label>
               ...
               <div className="space-y-4">
                  <label className="text-[10px] font-bold text-white/70 uppercase tracking-widest">Family Composition</label>
                  <div className="flex items-center gap-4">
                     <div className="flex-1 flex items-center justify-between bg-black/40 p-3 rounded-xl border border-white/5">
                        <span className="text-[10px] font-bold text-white/70 uppercase">Adults</span>
                     ...
                     <div className="flex-1 flex items-center justify-between bg-black/40 p-3 rounded-xl border border-white/5">
                        <span className="text-[10px] font-bold text-white/70 uppercase">Kids</span>
                        <div className="flex items-center gap-3">
             ...
             <div className="space-y-4">
                <label className="text-[10px] font-bold text-white/70 uppercase tracking-widest">Premium Riders & Add-ons</label>
          ...
          <div className="p-6 bg-[#D4AF37]/5 rounded-2xl border border-[#D4AF37]/10 flex items-center justify-between">
             ...
             <div className="text-right">
                <div className="text-[10px] text-white/70 font-bold uppercase tracking-widest">Monthly Split</div>
                <div className="text-xl font-bold text-white/70 tracking-tighter">{formatCurrency(results.monthlyPremium)}</div>
             </div>
          </div>
        </section>
             ...
             <>
               ...
               <div className="w-full grid grid-cols-2 gap-8 pt-8 border-t border-white/5">
                  <div className="space-y-2">
                     <div className="text-[10px] font-bold text-white/70 uppercase tracking-widest">Oldest Member</div>
                     <div className="text-lg font-bold">{inputs.oldestAge} Years</div>
                  </div>
                  <div className="space-y-2">
                     <div className="text-[10px] font-bold text-white/70 uppercase tracking-widest">Policy Type</div>
